...
const CardItem = (props) => {
  ...
  return (
    <div className="w-[345px] md:w-[355px] lg:w-[363px] h-[350px] hover:border-[3px] hover:border-solid hover:border-indigo-500 lg:hover:border-[3px] lg:hover:border-solid lg:hover:border-indigo-500 rounded-3xl gap-x-2 m-2  bg-gray-100 top-[486px] left-[287px] md:focus:mt-100 md:hover:border-none md:hover:border-indigo-500">
      ...
      <div className="flex justify-between">
        <h1 className="mt-2 ml-6 font-semibold text-[21px] text-gray-950 k">
          $ {props.Pay}
        </h1>
        {props.percentage > 0 && (
